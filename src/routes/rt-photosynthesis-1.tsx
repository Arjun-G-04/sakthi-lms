...
import { photosynthesisQuestions } from "#/components/PhotosynthesisSimulator/questions";

export const Route = createFileRoute("/rt-photosynthesis-1")({
	head: () => ({
		links: [
			{
				rel: "stylesheet",
	...
	return (
		<main className="relative min-h-screen text-[#1a2840] py-6 px-4 sm:px-6 lg:px-8">
			...
			<div className="mx-auto max-w-[1440px] space-y-4 relative z-10">
				...
				{isMounted ? (
					<Simulator
						testName="Photosynthesis in Higher Plants"
						subtitle="Class 11 Biology | Chapter Assessment"
						chaptersCovered={["Photosynthesis in Higher Plants"]}
